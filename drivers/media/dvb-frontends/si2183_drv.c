 ...
 *    (at your option) any latere version.
 *
...
extern void yyy_report(struct dvb_frontend* fe, const char* func, int line);
		...
		const struct i2c_device_id *id)
{
	...
	memcpy(&state->fe.ops, &si2183_ops, sizeof(struct dvb_frontend_ops));
